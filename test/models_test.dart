...
void main() {
  ...
  valueContract(
    ...
    changed: <ModelAiMessage>[
      ...
      msg.copyWith(
        parts: <ModelAiContentPart>[ModelAiTextPart(text: 'Another message')],
      ),
    ],
  );
  valueContract(
  ...
  test('input collections and returned JSON cannot mutate models', () {
    ...
    final List<dynamic> jsonParts =
        (jsonMessages.first as Map<String, dynamic>)['parts'] as List<dynamic>;
    (jsonParts.first as Map<String, dynamic>)['text'] = 'changed';
    jsonMessages.clear();
  ...
  test('constructors and copyWith enforce bounds without assertions', () {
    ...
    expect(
      () => ModelAiMessage.text(role: msg.role, text: ''),
      throwsArgumentError,
    );
    expect((message(' ').parts.single as ModelAiTextPart).text, ' ');
    expect(
      () => options.copyWith(stopSequences: <String>['']),
      throwsArgumentError,
    );
    ...
    cases =
        ...
        >[
          (
            json: msg.toJson(),
            decode: ModelAiMessage.fromJson,
            requiredKeys: <String>['role', 'parts'],
          ),
          (
            json: request.toJson(),
            decode: ModelAiRequest.fromJson,
